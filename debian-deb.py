...
pipeline = configurator \
    ...
    .ensure_replacement_of_pipeline("debian-deb") \
    .set_git_url("https://github.com/simon-services/debian-deb.git")
...
job_deb.ensure_artifacts({
    Artifact.get_test_artifact("debian-deb-0.0.1-amd64.deb","pkg")
})
